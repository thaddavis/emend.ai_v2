...
interface P {
  isModalOpen: boolean;
  setModalState: (state: { isModalOpen: boolean }) => {};
  callAI: (query: string) => {};
}

export const Modal = (props: P) => {
  const { isModalOpen, setModalState, callAI } = props;
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div>
                  <div className="mx-auto flex h-12 w-12 p-2 items-center justify-center rounded-full bg-[#2463eb]">
                    <Image
                      src={AI}
                      alt={"Ask Prompt"}
                      priority
                  ...
                  <div className="m-3 text-center sm:m-5">
                    <Dialog.Title
                      as="h3"
                ...
                <div>
                  <textarea
                    ...
                    className="block w-full rounded-md border-2 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
